...
type TooltipToolProps = React.ComponentProps<typeof TooltipTrigger>
const TooltipTool = (props: TooltipToolProps) => <TooltipTrigger {...props} />
...
TooltipTool.Trigger = Button
TooltipTool.Content = Content

export type TooltipProps = TooltipToolProps & {
  children: React.ReactNode
  showArrow?: boolean
...
export default function Tooltip({
  ...
  return (
    <TooltipTool>
      <TooltipTool.Trigger {...props}>{children}</TooltipTool.Trigger>
      <TooltipTool.Content
        showArrow={showArrow}
        intent={intent}
        offset={offset}
...
export type { TooltipContentProps, TooltipToolProps }
