...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_hero_links_link_appearance" AS ENUM('plain', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_appearance" AS ENUM('plain', 'outline', 'solid');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_link_appearance" AS ENUM('plain', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_archive_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_hero_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_version_hero_links_link_appearance" AS ENUM('plain', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" AS ENUM('plain', 'outline', 'solid');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance" AS ENUM('plain', 'outline');
  ...
  CREATE TABLE IF NOT EXISTS "pages_hero_links" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_hero_links_link_appearance" DEFAULT 'plain'
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_cta_links" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_cta_links_link_appearance" DEFAULT 'plain'
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content_columns" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_content_columns_link_appearance" DEFAULT 'plain'
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_version_hero_links" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_version_hero_links_link_appearance" DEFAULT 'plain',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_cta_links" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_cta_links_link_appearance" DEFAULT 'plain',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content_columns" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_content_columns_link_appearance" DEFAULT 'plain',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "chapters_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "_chapters_v_version_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_stories_v_version_chapters" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_stories_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_meta_title" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "chapters_images" ADD CONSTRAINT "chapters_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."chapters"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "chapters" ADD CONSTRAINT "chapters_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "chapters_rels" ADD CONSTRAINT "chapters_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_chapters_v_version_images" ADD CONSTRAINT "_chapters_v_version_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_chapters_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_chapters_v" ADD CONSTRAINT "_chapters_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_chapters_v_rels" ADD CONSTRAINT "_chapters_v_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "stories_chapters" ADD CONSTRAINT "stories_chapters_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."stories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "stories_rels" ADD CONSTRAINT "stories_rels_chapters_fk" FOREIGN KEY ("chapters_id") REFERENCES "public"."chapters"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_stories_v_version_chapters" ADD CONSTRAINT "_stories_v_version_chapters_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_stories_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_stories_v_rels" ADD CONSTRAINT "_stories_v_rels_chapters_fk" FOREIGN KEY ("chapters_id") REFERENCES "public"."chapters"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "chapters_images_order_idx" ON "chapters_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "chapters_images_parent_id_idx" ON "chapters_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "chapters_meta_meta_image_idx" ON "chapters" USING btree ("meta_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "chapters_rels_media_id_idx" ON "chapters_rels" USING btree ("media_id");
  CREATE INDEX IF NOT EXISTS "_chapters_v_version_images_order_idx" ON "_chapters_v_version_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_chapters_v_version_images_parent_id_idx" ON "_chapters_v_version_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_chapters_v_parent_idx" ON "_chapters_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_chapters_v_version_meta_version_meta_image_idx" ON "_chapters_v" USING btree ("version_meta_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_chapters_v_autosave_idx" ON "_chapters_v" USING btree ("autosave");
  ...
  CREATE INDEX IF NOT EXISTS "_chapters_v_rels_media_id_idx" ON "_chapters_v_rels" USING btree ("media_id");
  CREATE INDEX IF NOT EXISTS "stories_chapters_order_idx" ON "stories_chapters" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "stories_chapters_parent_id_idx" ON "stories_chapters" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "stories_meta_meta_image_idx" ON "stories" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "stories_slug_idx" ON "stories" USING btree ("slug");
  ...
  CREATE INDEX IF NOT EXISTS "stories__status_idx" ON "stories" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "stories_rels_order_idx" ON "stories_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "stories_rels_parent_idx" ON "stories_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "stories_rels_path_idx" ON "stories_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "stories_rels_chapters_id_idx" ON "stories_rels" USING btree ("chapters_id");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_chapters_order_idx" ON "_stories_v_version_chapters" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_chapters_parent_id_idx" ON "_stories_v_version_chapters" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_stories_v_parent_idx" ON "_stories_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_meta_version_meta_image_idx" ON "_stories_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_version_slug_idx" ON "_stories_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_version_updated_at_idx" ON "_stories_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_version_created_at_idx" ON "_stories_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_stories_v_version_version__status_idx" ON "_stories_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_stories_v_created_at_idx" ON "_stories_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_stories_v_updated_at_idx" ON "_stories_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_stories_v_latest_idx" ON "_stories_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_stories_v_autosave_idx" ON "_stories_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "_stories_v_rels_order_idx" ON "_stories_v_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_stories_v_rels_parent_idx" ON "_stories_v_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_stories_v_rels_path_idx" ON "_stories_v_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "_stories_v_rels_chapters_id_idx" ON "_stories_v_rels" USING btree ("chapters_id");
